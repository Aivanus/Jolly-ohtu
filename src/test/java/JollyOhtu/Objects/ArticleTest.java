...
public class ArticleTest {
    ...
    public void articleIsCreatedProperly() throws Exception {
        ...
        assertEquals(article.toString(), "Article{author=Author, title=Title, journal=Journal, year=1995, volume=1, number=0, pages=null, month=0, note=null}");
    ...
    public void articleCreatedProperlyLongConstructor() throws Exception {
        ...
        assertEquals(article.toString(), "Article{author=Author, title=Title, journal=Journal, year=1995, volume=1, number=0, pages=10-15, month=9, note=Note}");
    }
